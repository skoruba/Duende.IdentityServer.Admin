...
export interface IApiResourcesClient {
    ...
    get(searchText: string | null | undefined, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<ApiResourcesApiDto>;

    post(apiResourceApi: ApiResourceApiDto,  cancelToken?: CancelToken): Promise<void>;

    put(apiResourceApi: ApiResourceApiDto,  cancelToken?: CancelToken): Promise<void>;

    canInsertApiResource(id: number | undefined, name: string | null | undefined,  cancelToken?: CancelToken): Promise<boolean>;

    canInsertApiResourceProperty(id: number | undefined, key: string | null | undefined,  cancelToken?: CancelToken): Promise<boolean>;

    get2(id: number,  cancelToken?: CancelToken): Promise<ApiResourceApiDto>;

    delete(id: number,  cancelToken?: CancelToken): Promise<void>;

    getSecrets(id: number, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<ApiSecretsApiDto>;

    postSecret(id: number, clientSecretApi: ApiSecretApiDto,  cancelToken?: CancelToken): Promise<ApiSecretApiDto>;

    getSecret(secretId: number,  cancelToken?: CancelToken): Promise<ApiSecretApiDto>;

    deleteSecret(secretId: number,  cancelToken?: CancelToken): Promise<void>;

    getProperties(id: number, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<ApiResourcePropertiesApiDto>;

    postProperty(id: number, apiPropertyApi: ApiResourcePropertyApiDto,  cancelToken?: CancelToken): Promise<ApiResourcePropertyApiDto>;

    getProperty(propertyId: number,  cancelToken?: CancelToken): Promise<ApiResourcePropertyApiDto>;

    deleteProperty(propertyId: number,  cancelToken?: CancelToken): Promise<void>;
}
...
export interface IApiScopesClient {
    ...
    getScopes(search: string | null | undefined, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<ApiScopesApiDto>;

    postScope(apiScopeApi: ApiScopeApiDto,  cancelToken?: CancelToken): Promise<ApiScopeDto>;

    putScope(apiScopeApi: ApiScopeApiDto,  cancelToken?: CancelToken): Promise<void>;

    canInsertApiScope(id: number | undefined, name: string | null | undefined,  cancelToken?: CancelToken): Promise<boolean>;

    canInsertApiScopeProperty(id: number | undefined, key: string | null | undefined,  cancelToken?: CancelToken): Promise<boolean>;

    getScope(id: number,  cancelToken?: CancelToken): Promise<ApiScopeApiDto>;

    deleteScope(id: number,  cancelToken?: CancelToken): Promise<void>;

    getScopeProperties(id: number, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<ApiScopePropertiesApiDto>;

    postProperty(id: number, apiScopePropertyApi: ApiScopePropertyApiDto,  cancelToken?: CancelToken): Promise<ApiScopePropertyApiDto>;

    getProperty(propertyId: number,  cancelToken?: CancelToken): Promise<ApiScopePropertyApiDto>;
...
export interface IClientsClient {
    ...
    get(searchText: string | null | undefined, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<ClientsApiDto>;

    post(client: ClientApiDto,  cancelToken?: CancelToken): Promise<ClientApiDto>;

    put(client: ClientApiDto,  cancelToken?: CancelToken): Promise<void>;

    get2(id: number,  cancelToken?: CancelToken): Promise<ClientApiDto>;

    delete(id: number,  cancelToken?: CancelToken): Promise<void>;

    getAccessTokenTypes( cancelToken?: CancelToken): Promise<SelectItemDto[]>;

    getTokenExpirations( cancelToken?: CancelToken): Promise<SelectItemDto[]>;

    getTokenUsage( cancelToken?: CancelToken): Promise<SelectItemDto[]>;

    getProtocolTypes( cancelToken?: CancelToken): Promise<SelectItemDto[]>;

    getDPoPValidationModes( cancelToken?: CancelToken): Promise<SelectItemDto[]>;

    getScopes(scope: string | null | undefined, limit: number | undefined, excludeIdentityResources: boolean | undefined, excludeApiScopes: boolean | undefined,  cancelToken?: CancelToken): Promise<string[]>;

    getGrantTypes(grant: string | null | undefined, includeObsoleteGrants: boolean | undefined, limit: number | undefined,  cancelToken?: CancelToken): Promise<SelectItemDto[]>;

    getHashTypes( cancelToken?: CancelToken): Promise<SelectItemDto[]>;

    getSecretTypes( cancelToken?: CancelToken): Promise<SelectItemDto[]>;

    getStandardClaims(claim: string | null | undefined, limit: number | undefined,  cancelToken?: CancelToken): Promise<string[]>;

    getSigningAlgorithms(algorithm: string | null | undefined, limit: number | undefined,  cancelToken?: CancelToken): Promise<string[]>;

    canInsertClient(id: number | undefined, clientId: string | null | undefined, isCloned: boolean | undefined,  cancelToken?: CancelToken): Promise<boolean>;

    postClientClone(client: ClientCloneApiDto,  cancelToken?: CancelToken): Promise<ClientApiDto>;

    getSecrets(id: number, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<ClientSecretsApiDto>;

    postSecret(id: number, clientSecretApi: ClientSecretApiDto,  cancelToken?: CancelToken): Promise<ClientSecretApiDto>;

    getSecret(secretId: number,  cancelToken?: CancelToken): Promise<ClientSecretApiDto>;

    deleteSecret(secretId: number,  cancelToken?: CancelToken): Promise<void>;

    getProperties(id: number, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<ClientPropertiesApiDto>;

    postProperty(id: number, clientPropertyApi: ClientPropertyApiDto,  cancelToken?: CancelToken): Promise<ClientPropertyApiDto>;

    getProperty(propertyId: number,  cancelToken?: CancelToken): Promise<ClientPropertyApiDto>;

    deleteProperty(propertyId: number,  cancelToken?: CancelToken): Promise<void>;

    getClaims(id: number, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<ClientClaimsApiDto>;

    postClaim(id: number, clientClaimApiDto: ClientClaimApiDto,  cancelToken?: CancelToken): Promise<ClientClaimApiDto>;

    getClaim(claimId: number,  cancelToken?: CancelToken): Promise<ClientClaimApiDto>;

    deleteClaim(claimId: number,  cancelToken?: CancelToken): Promise<FileResponse>;
}
...
export interface IConfigurationIssuesClient {
    ...
    get( cancelToken?: CancelToken): Promise<ConfigurationIssueDto[]>;

    getSummary( cancelToken?: CancelToken): Promise<ConfigurationIssueSummaryDto>;
}
...
export interface IDashboardClient {
    ...
    getDashboardIdentityServer(auditLogsLastNumberOfDays: number | undefined,  cancelToken?: CancelToken): Promise<DashboardDto>;

    getDashboardIdentity( cancelToken?: CancelToken): Promise<DashboardIdentityDto>;
}
...
export interface IIdentityProvidersClient {
    ...
    get(searchText: string | null | undefined, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<IdentityProvidersApiDto>;

    post(identityProviderApi: IdentityProviderApiDto,  cancelToken?: CancelToken): Promise<void>;

    put(identityProviderApi: IdentityProviderApiDto,  cancelToken?: CancelToken): Promise<FileResponse>;

    canInsertIdentityProvider(id: number | undefined, schema: string | null | undefined,  cancelToken?: CancelToken): Promise<boolean>;

    get2(id: number,  cancelToken?: CancelToken): Promise<IdentityProviderApiDto>;

    delete(id: number,  cancelToken?: CancelToken): Promise<FileResponse>;
}
...
export interface IIdentityResourcesClient {
    ...
    get(searchText: string | null | undefined, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<IdentityResourcesApiDto>;

    post(identityResourceApi: IdentityResourceApiDto,  cancelToken?: CancelToken): Promise<IdentityResourceApiDto>;

    put(identityResourceApi: IdentityResourceApiDto,  cancelToken?: CancelToken): Promise<void>;

    get2(id: number,  cancelToken?: CancelToken): Promise<IdentityResourceApiDto>;

    delete(id: number,  cancelToken?: CancelToken): Promise<void>;

    canInsertIdentityResource(id: number | undefined, name: string | null | undefined,  cancelToken?: CancelToken): Promise<boolean>;

    canInsertIdentityResourceProperty(id: number | undefined, key: string | null | undefined,  cancelToken?: CancelToken): Promise<boolean>;

    getProperties(id: number, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<IdentityResourcePropertiesApiDto>;

    postProperty(id: number, identityResourcePropertyApi: IdentityResourcePropertyApiDto,  cancelToken?: CancelToken): Promise<IdentityResourcePropertyApiDto>;

    getProperty(propertyId: number,  cancelToken?: CancelToken): Promise<IdentityResourcePropertyApiDto>;
...
export interface IInfoClient {
    ...
    getApplicationVersion( cancelToken?: CancelToken): Promise<string>;

    getApplicationName( cancelToken?: CancelToken): Promise<string>;
}
...
export interface IKeysClient {
    ...
    get(page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<KeysApiDto>;

    get2(id: string,  cancelToken?: CancelToken): Promise<KeyApiDto>;
...
export interface ILogsClient {
    ...
    auditLog(event: string | null | undefined, source: string | null | undefined, category: string | null | undefined, createdDate: string | null | undefined, subjectIdentifier: string | null | undefined, subjectName: string | null | undefined, pageSize: number | undefined, page: number | undefined,  cancelToken?: CancelToken): Promise<AuditLogsDto>;
}
...
export interface IPersistedGrantsClient {
    ...
    get(searchText: string | null | undefined, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<PersistedGrantSubjectsApiDto>;

    get2(id: string,  cancelToken?: CancelToken): Promise<PersistedGrantApiDto>;

    delete(id: string,  cancelToken?: CancelToken): Promise<FileResponse>;

    getBySubject(subjectId: string, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<PersistedGrantsApiDto>;

    deleteBySubject(subjectId: string,  cancelToken?: CancelToken): Promise<FileResponse>;
}
...
export interface IRolesClient {
    ...
    get2(searchText: string | null | undefined, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<IdentityRolesDto>;

    post(role: IdentityRoleDto,  cancelToken?: CancelToken): Promise<IdentityRoleDto>;

    put(role: IdentityRoleDto,  cancelToken?: CancelToken): Promise<FileResponse>;

    getRoleUsers(id: string, searchText: string | null | undefined, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<IdentityUsersDto>;

    getRoleClaims(id: string, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<RoleClaimsApiDtoOfString>;

    deleteRoleClaims(id: string, claimId: number | undefined,  cancelToken?: CancelToken): Promise<FileResponse>;

    postRoleClaims(roleClaims: RoleClaimApiDtoOfString,  cancelToken?: CancelToken): Promise<FileResponse>;

    putRoleClaims(roleClaims: RoleClaimApiDtoOfString,  cancelToken?: CancelToken): Promise<FileResponse>;
}
...
export interface IUsersClient {
    ...
    get2(searchText: string | null | undefined, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<IdentityUsersDto>;

    post(user: IdentityUserDto,  cancelToken?: CancelToken): Promise<IdentityUserDto>;

    put(user: IdentityUserDto,  cancelToken?: CancelToken): Promise<FileResponse>;

    getUserRoles(id: string, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<UserRolesApiDtoOfIdentityRoleDto>;

    postUserRoles(role: UserRoleApiDtoOfString,  cancelToken?: CancelToken): Promise<FileResponse>;

    deleteUserRoles(role: UserRoleApiDtoOfString,  cancelToken?: CancelToken): Promise<FileResponse>;

    getUserClaims(id: string, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<UserClaimsApiDtoOfString>;

    deleteUserClaims(id: string, claimId: number | undefined,  cancelToken?: CancelToken): Promise<FileResponse>;

    postUserClaims(claim: UserClaimApiDtoOfString,  cancelToken?: CancelToken): Promise<FileResponse>;

    putUserClaims(claim: UserClaimApiDtoOfString,  cancelToken?: CancelToken): Promise<FileResponse>;

    getUserProviders(id: string,  cancelToken?: CancelToken): Promise<UserProvidersApiDtoOfString>;

    deleteUserProviders(provider: UserProviderDeleteApiDtoOfString,  cancelToken?: CancelToken): Promise<FileResponse>;

    postChangePassword(password: UserChangePasswordApiDtoOfString,  cancelToken?: CancelToken): Promise<FileResponse>;

    getRoleClaims(id: string, claimSearchText: string | null | undefined, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<RoleClaimsApiDtoOfString>;

    getClaimUsers(claimType: string, claimValue: string, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<IdentityUsersDto>;

    getClaimUsers2(claimType: string, page: number | undefined, pageSize: number | undefined,  cancelToken?: CancelToken): Promise<IdentityUsersDto>;
}
