...
namespace Skoruba.Duende.IdentityServer.Admin.UI.Areas.AdminUI.Controllers
{
	...
	public class ConfigurationController : BaseController
	{
		...
		[HttpGet]
		public async Task<IActionResult> ClientExport(int id)
		{
			if (id == 0) return NotFound();
			...
			string jsonString = JsonSerializer.Serialize(client, options);

			var fileName = $"Client_{client.ClientName}_{client.ClientId}.json";
