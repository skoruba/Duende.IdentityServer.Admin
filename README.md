...
[![Build status](https://ci.appveyor.com/api/projects/status/5yg59bn70399hn6s/branch/master?svg=true)](https://ci.appveyor.com/project/JanSkoruba/duende-identityserver-admin/branch/master)
...
```sh
dotnet new -i Skoruba.Duende.IdentityServer.Admin.Templates::1.0.0-preview-1
```
